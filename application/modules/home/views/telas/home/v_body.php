...
<div style="text-align: center;" class="container">
	...
	<!-- Botão de Like e compartilhamento no Facebook --> 
	<div
		class="fb-like"
		data-share="true"
		data-width="450"
	...
	<script>
		(function(d, s, id) {
			...
			if (d.getElementById(id)) return;
			js = d.createElement(s); js.id = id;
			js.src = "//connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v2.5&appId=1686504724926931";
			fjs.parentNode.insertBefore(js, fjs);
		}(document, 'script', 'facebook-jssdk'));
	</script>

	<div class="fb-comments" data-href="http://developers.facebook.com/docs/plugins/comments/" 
		data-width="teste" data-numposts="1">
	</div>
	<!-- ! Comentario Facebook -->
